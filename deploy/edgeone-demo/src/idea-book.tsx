...
const fixtures: Idea[] = [
  { id: "demo-idea-idc", title: "China IDC pricing recovery", ticker: "DEMO IDC", owner: { display_name: "Demo PM" }, status: "pending_review", direction: "long", thesis: "Synthetic example: test whether supply discipline and signed contract pricing support a durable earnings inflection.", noteIds: ["demo-note-idc-pricing"], noteTitles: ["AI data centre pricing · meeting notes"], version: 3, updatedAt: "2026-08-03T02:00:00.000Z" },
  { id: "demo-idea-ads", title: "Internet advertising inflection", ticker: "DEMO ADS", owner: { display_name: "Demo Analyst" }, status: "draft", direction: "watch", thesis: "Synthetic example: separate cyclical demand recovery from share gain before submitting for review.", noteIds: ["demo-note-consumer-tracker"], noteTitles: ["Consumer internet weekly tracker"], version: 1, updatedAt: "2026-08-02T09:00:00.000Z" },
];
