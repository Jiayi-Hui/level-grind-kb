...
export const researchEvents = sqliteTable(
  "research_events",
  {
    ...
    eventNature: text("event_nature").notNull().default("actual"),
    impactType: text("impact_type").notNull().default("fundamental"),
    impactDirection: text("impact_direction").notNull().default("mixed"),
    ...
    metricObject: text("metric_object"),
    ...
    rawClaim: text("raw_claim"),
    verificationPlan: text("verification_plan"),
    pmRelevance: text("pm_relevance"),
  ...
  (table) => [
    index("research_events_type_date_idx").on(table.eventType, table.eventDate),
    index("research_events_company_date_idx").on(table.company, table.eventDate),
    index("research_events_priority_idx").on(table.priority),
